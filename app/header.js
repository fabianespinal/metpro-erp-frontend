        ...
        <div className='flex justify-between h-16 items-center'>
          <div className='flex items-center gap-3'>
            ...
            <nav className='hidden md:flex gap-8 ml-8'>
              <Link href='/clients' className='text-white/80 hover:text-white font-medium transition'>👥 Clients</Link>
              <Link href='/quotes' className='text-white/80 hover:text-white font-medium transition'>📝 Quotes</Link>
              <Link href='/products' className='text-white/80 hover:text-white font-medium transition'>📦 Products</Link>
            </nav>
          </div>
